...
Page({
  ...
  onSendTap(e){
    ...
    var url="http://localhost:8080/TeachDemo_war_exploded/project_todo_servlet_action"
  ...
  getDeviceStatus(){
    ...
    var data = { "action": "get_todo_record", "sql": sql };
    //var data = { "action": "query_record", "sql": sql };
    wx.request({
      url: url,
      data: data,
      header: { "content-type": "application/x-www-form-urlencoded", "x-requested-with": "XMLHttpRequest", },
  ...
  createMarker(point) {
    ...
    let marker = {
      //iconPath: "../../assets/module/img/gps/marker.png",   //32*47
      iconPath: "../../images/marker.png",   //32*32
      id: point.id || 0,
